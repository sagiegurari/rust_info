...
[![crates.io](https://img.shields.io/crates/v/rust_info.svg)](https://crates.io/crates/rust_info) [![Build Status](https://travis-ci.org/sagiegurari/rust_info.svg?branch=master)](http://travis-ci.org/sagiegurari/rust_info) [![Build status](https://ci.appveyor.com/api/projects/status/github/sagiegurari/rust-info?branch=master&svg=true)](https://ci.appveyor.com/project/sagiegurari/rust-info) [![codecov](https://codecov.io/gh/sagiegurari/rust_info/branch/master/graph/badge.svg)](https://codecov.io/gh/sagiegurari/rust_info)<br>
